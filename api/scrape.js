  ...
  try {
    ...
    var response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: 'Extract the recipe from this webpage text. If ingredients are grouped into sub-sections, list all ingredients together without the group labels. Return ONLY valid JSON, no markdown, no smart quotes:\n{"title":"Recipe name","author":"Author or empty string","servings":"4 or empty string","category":"Dinner","ingredients":["ingredient 1"],"method":["Step 1"],"notes":"Any tips or notes or empty string"}\n\nWebpage text:\n' + html
        }]
      })
    });
